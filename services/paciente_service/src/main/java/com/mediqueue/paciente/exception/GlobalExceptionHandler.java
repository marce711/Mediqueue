...
import com.mediqueue.paciente.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(PacienteNotFoundException exception, HttpServletRequest request) {
